...
$document.ready(function () {
	...
	$().UItoTop({
		...
		containerClass: 'ui-to-top fa-angle-up fa-2'
	});
	}
				...
				.on("scroll", $.proxy(function () {
					...
					if ((!$this.hasClass("animated")) && (isScrolledIntoView($this))) {
						$this.countTo({
							...
							speed: $this.attr("data-speed") || 1500,
	...
	for (i = 0; i < plugins.dateCountdown.length; i++) {
		...
		animation: "smooth",
		bg_width: dateCountdownItem.attr("data-bg-width") ? dateCountdownItem.attr("data-bg-width") : 0.7,
...
$(window).load(function(){
	var navbarClassName = $('.swiper-custom-container').hasClass('swiper-creative');
	if( navbarClassName === true ) {
		$('.page').addClass('page-swiper-creative');
	}
});